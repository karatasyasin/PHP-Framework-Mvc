                ...
                <div class="p-5">
                  <div class="text-center">
                    ...
                    <div class="form-group">
                        ...
                        <?php
                    Form::Olustur("2",array("type"=>"text","class"=>"form-control form-control-user","name"=>"AdminAd","autofocus"=>"autofocus","required"=>"required","placeholder"=>"Kullanıcı adınızı giriniz"));
                        ?>
                    </div>

                    <div class="form-group">
                        <?php
                        Form::Olustur("2",array("type"=>"password","class"=>"form-control form-control-user","name"=>"Adminsifre","required"=>"required","placeholder"=>"Şifreniz","id"=>"exampleInputPassword"));
                        ?>
                    </div>
