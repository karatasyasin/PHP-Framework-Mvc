        ...
        <div class="col-xl-12 col-md-12 mb-12 text-center">
            ...
            if (isset($veri["Urunguncelle"])) :
                ...
                <div class="row text-left border-bottom-mvc mb-2">
                    ...
                    <div class="col-xl-12 col-md-12 mb-12 border-left-mvc text-left p-2 mb-2">
                        <h1 class="h3 mb-0 text-gray-800"> <i class="fas fa-th basliktext"></i> ÜRÜN GÜNCELLE </h1></div>
                                    ...
                                    <div class="row">
                                        ...
                                        <div class="col-lg-6 col-xl-6 col-md-6 col-sm-12 bloklararasi">
                                            <div class="row">
                                                ...
                                                <div class="col-lg-3 col-xl-3 col-md-3 col-sm-12 uruneklemeElemanlar">Kategori
                                                    <br><span id="sifirla" class="text-danger">SIFIRLA</span> </div>
                                                <div class="col-lg-9 col-xl-9 col-md-9 col-sm-12 uruneklemeElemanlarDiger"> <?php
            ...
            <div class="row text-left border-bottom-mvc mb-2">
                ...
                <div class="col-lg-1 col-xl-1 col-md-12 mb-12 pt-1">
                    <a href="<?php echo URL."/panel/Urunekle/ilk";?>" class="btn btn-sm btn-success btn-block">EKLE</a>
                </div>
                ...
                <div class="col-lg-9 col-xl-9 col-md-12 mb-12 text-right">
                    <div class="row">
                        ...
                        <div class="col-xl-2">
                            ...
                            Form::Olustur("2",array("type"=>"text","name"=>"arama","class"=>"form-control","placeholder"=>"Arama"));
...
<div class="col-lg-2 col-xl-2 col-md-12 col-sm-12 text-dark kalinyap p-2">';
                    ...
                    $bilgicek=$PanelHarici->kategorilerial(
                        ...
                        "(ana_kategori.id=".$value['ana_kat_id'].") AND
                        (cocuk_kategori.id=".$value['cocuk_kat_id'].") AND
                        (alt_kategori.id=".$value['katid'].")"
                    );


                    echo $bilgicek[0]["anakatad"]." | ".$bilgicek[0]["cocukad"]." | ".$bilgicek[0]["altad"];
...
<a href="'.URL.'/panel/urunGuncelle/ilk/'.$value["id"].'" class="fas fa-sync mt-1 guncelbuton"></a>
<a href="'.URL.'/panel/urunSil/'.$value["id"].'" class="fas fa-times silbuton ml-2"></a></div>
                ...
                elseif(isset($veri["katid"])):
                    $link="/panel/katgoregetir/".$Harici->seo($veri["katid"])."/";
                else:
                    $link="/panel/urunler/";
                endif;
