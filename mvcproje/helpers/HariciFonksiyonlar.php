...
BURADA SİTENİN TÜM ÜYE AYARLARINI VE DİĞER FONKSİYONLARIMI BARINDIRIYOR

*/

class  HariciFonksiyonlar  extends Model{

    public $sonuc,$title,$sayfaAciklama,$anahtarKelime;

    public $linkler=array(),$encoksatan=array(),$stoguazalan=array(),$populerkategori=array(),$slider=array();
...
<div class="col-lg-3 urunler">'.$siparisler[$i]["toplamfiyat"].'</div>             
 ...
 <div class="col-md-12 text-center">';
        ...
        echo count($dizimiz)>0 ? '<div class="alert alert-info">'.count($dizimiz). ' adet adresiniz kayıtlıdır<a href="'.URL.'/uye/adresekle" class="btn btn-sm btn-success">ADRES EKLE</a></div>' : '<div class="alert alert-info">Kayıtlı adresiniz bulunmamaktadır.<a href="'.URL.'/uye/adresekle" class="btn btn-sm btn-success">ADRES EKLE</a></div>';
        echo'</div>';
...
?>
            <a onclick='UrunSil("<?php echo $deger["id"] ?>","adresSil")' class="btn btn-sm btn-primary btn-block" id="AdresSilBtn">SİL</a>

            <?php
              echo $deger["varsayilan"]==1 ?
                  '<a  class="btn btn-sm btn-primary btn-danger btn-block" id="AdresSilBtn">VARSAYILAN ADRES</a>' :
                    '<a onclick=\'VarsayilanYap("'.$deger["uyeid"].'","'.$deger["id"].'")\' class="btn btn-sm btn-primary btn-block" id="AdresSilBtn">VARSAYILAN YAP</a>';
